...
将onnxruntime.h和opencv_world455.dll（opencv_world455d.dll debug模式）放到exe路径下，opencv运行cppDemo.exe，并设置参数，例如--mode panorama --lg D:\\superpoint_lightglue.onnx --sp D:\\superpoint.onnx D:\\1.jpg D:\2.jpg   
